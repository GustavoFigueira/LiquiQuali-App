...
class _MyAppState extends State<MyApp> {
  ...
  void _flash(Duration duration) async {
    await Fflashlight.flash(duration);
  }
        ...
        body: Center(
          child: Column(
            children: <Widget>[
              ...
              MaterialButton(
                onPressed: () => _flash(Duration(milliseconds: 300)),
                child: new Text('Flash',
